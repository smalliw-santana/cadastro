                ...
                <form onSubmit={handleSubmit} className="p-8 grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="md:col-span-1 flex flex-col items-center space-y-6">
                        <div className="relative group">
                            <div className="w-40 h-40 rounded-3xl bg-slate-100 flex items-center justify-center overflow-hidden border-4 border-white shadow-2xl ring-1 ring-slate-200 group-hover:ring-primary-500 transition-all">
                                {formData.avatarUrl ? (
                            ...
                            <button 
                                ...
                                className="absolute -bottom-3 -right-3 p-3 bg-primary-600 text-white rounded-2xl shadow-lg hover:bg-primary-700 active:scale-90 transition-all border-4 border-white"
                                title="Alterar Foto"
                            >
                        ...
                        <div className="w-full space-y-3">
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                                {PREDEFINED_AVATARS.map((url, i) => (
                                    ...
                                    >
                                        <img src={url} alt={`Avatar ${i}`} className="w-full h-full object-cover bg-slate-50" referrerPolicy="no-referrer" />
                                    </button>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="md:col-span-2 space-y-6">
                        ...
                        {feedback && (
                            <div className={`p-4 rounded-xl flex items-center gap-3 animate-[fadeIn_0.3s] ${feedback.type === 'success' ? 'bg-green-50 text-green-700 border border-green-100' : 'bg-red-50 text-red-700 border border-red-100'}`}>
