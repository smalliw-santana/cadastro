...
export const SystemUsersManagement: React.FC<SystemUsersManagementProps> = ({ currentUser }) => {
  ...
  const handleAddUser = async (e: React.FormEvent) => {
      ...
      if (editingUserId) {
        ...
        if (result.success) {
            setSuccessItemName(newUser.nome.toUpperCase());
            if (currentUser) {
  ...
  const handleExecuteDelete = async () => {
      ...
      if (result.success) {
          setSuccessItemName(userToDelete.nome);
          if (currentUser) {
              await dbService.addLog({
                  userName: currentUser.nome,
                  action: 'DELETE',
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/80 backdrop-blur-md animate-[fadeIn_0.3s_ease-out]">
                <div className="flex flex-col items-center text-center p-8 animate-pop-in">
                    ...
                    <p className="text-red-100 text-lg animate-fade-slide-up [animation-delay:0.2s]">
                        O acesso de <span className="font-bold">{successItemName}</span> foi removido.
                    </p>
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/80 backdrop-blur-md animate-[fadeIn_0.3s_ease-out]">
                <div className="flex flex-col items-center text-center p-8 animate-pop-in">
                    ...
                    <p className="text-green-100 text-lg animate-fade-slide-up [animation-delay:0.2s]">
                        Os dados de <span className="font-bold">{successItemName}</span> foram salvos.
                    </p>
                    <div className="mt-8 flex gap-2">
